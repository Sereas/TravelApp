-- Add user_image_url column to locations table for user-uploaded photo overrides
ALTER TABLE locations ADD COLUMN IF NOT EXISTS user_image_url TEXT;

-- Drop and recreate get_itinerary_tree with user_image_url column
...
-- Create user-photos storage bucket (public read)
