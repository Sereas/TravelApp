...
| `src/components/locations/` | LocationRow (name, address, Google Maps link, note), AddLocationForm, EditLocationRow. See [location-fields-and-ui.md](../docs/features/location-fields-and-ui.md). |
