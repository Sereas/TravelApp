    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        {!loading && trips.length > 0 && (
          <CreateTripDialog
            trigger={
              <Button className="cursor-pointer rounded-full bg-primary px-6 font-semibold text-white shadow-sm transition-all duration-200 hover:bg-primary-strong hover:shadow-md">
                New trip
              </Button>
            }
        ...
        <div className="flex justify-center py-8">
          <div className="w-full max-w-md rounded-xl border border-border bg-card px-8 py-12 text-center shadow-sm">
            ...
            <div className="mt-6">
              <CreateTripDialog
                trigger={
                  <Button className="cursor-pointer rounded-full bg-primary px-8 py-2.5 font-semibold text-white shadow-sm transition-all duration-200 hover:bg-primary-strong hover:shadow-md">
          ...
          <div className="flex gap-2" role="tablist" aria-label="Trip filters">
            {FILTERS.map(({ value, label }) => (
              <button
                ...
                className={`cursor-pointer rounded-full px-4 py-1.5 text-sm font-medium transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-offset-2 ${
                  filter === value
